...
def load_data():
    ...
    for platform in conf.platform_info:
        ...
        total_games = total_games + len(gamelist)
        total_screenshots = total_screenshots + len(screenshotlist)    
        ...
        for ssc_index, ssc_row in screenshotcount.iterrows():
            ...
            if ssc_row.sc_count>=5:
                ...
                for fs_index, fs_row in filtered_screenshots.iterrows():
                    ...
                    game_ids.append(str(platform) + str(fs_row.game_id))
...
def train_test_model(train_df, test_df, model, preprocessing_function, image_size, split, batch_size):
    ...
    # save history
    history_filename = "./results/history/vg-history-allplatforms-" + model.name + "-" + str(split) + ".npy"
...
if __name__ == "__main__":
    ...
    # create filenames
    log_filename = "vg-allplatforms-" + hostname + ".log"
    csv_filename = "vg-allplatforms-" + hostname + ".csv"
