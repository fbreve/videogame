...
def train_test_model(train_df, test_df, model, preprocessing_function, image_size, split, batch_size, platform):
    ...
    # save history
    history_filename = "./results/history/vg-history-loadweights-platform" + str(platform) + "-" + model.name + "-" + str(split) + ".npy"
...
if __name__ == "__main__":
    ...
    # create filenames
    log_filename = "videogame-loadweight-" + conf.MODEL_TYPE + "-" + hostname + ".log"
    csv_acc_filename = "videogame-lw-acc-" + conf.MODEL_TYPE + "-" + hostname + ".csv"
    csv_epc_filename = "videogame-lw-epc-" + conf.MODEL_TYPE + "-" + hostname + ".csv"
